<template>
    <jet-form-section @submitted="updatePersonalInformation">
        ...
        <template #form>
            ...
            <div class="col-span-6 sm:col-span-6">
                <jet-label for="place_of_birth" value="Место рождения" />
                <jet-input id="place_of_birth" type="text" class="mt-1 block w-full" v-model="form.place_of_birth" autocomplete="place_of_birth" />
                <jet-input-error :message="form.errors.place_of_birth" class="mt-2" />
            </div>

            <div class="col-span-6 sm:col-span-6">
                <jet-label for="snils" value="СНИЛС" />
                <input
                    id="snils"
                    type="text" v-model="form.snils" autocomplete="snils"
...
export default defineComponent({
    ...
    methods: {
        updatePersonalInformation() {
            this.form.post(route('papers.store'), {
